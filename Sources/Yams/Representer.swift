...
extension Dictionary: NodeRepresentable {
  /// This value's `Node` representation.
  public func represented() throws -> Node {
    let pairs = try map { try (key: represent($0.0), value: represent($0.1)) }
...
public extension ScalarRepresentable {
  /// This value's `Node.scalar` representation.
  func represented() throws -> Node {
...
public extension YAMLEncodable where Self: ScalarRepresentable {
